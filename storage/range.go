...
// SoftDestroy cleans up all metadata associated with this range, but leaves the data intact.
// The common use case for this function is when doing a merge between two adjacent ranges.
func (r *Range) SoftDestroy() error {
	// Remove all the transactions records that are stored in this range.
	...
	// Clear all metadata for this range.
